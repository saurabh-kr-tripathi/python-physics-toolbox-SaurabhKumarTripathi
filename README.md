...
>> last print the name of the particle and return the valuse of kinetic energy in both the Units.
>> we can also calculate Potential Energy of the system using the formula of Electric-potential -energy.
>> We can also make a energy Bar Chart in this program for Bonus Marks.

**Third Code**
TASK 4: **Regex Optics Data Clearing**
Purpose: To cleaning the optical Data and puing in a list to use further thing
>> Take Data from the code itself.
>> then use for loop to store all the given values from teh list.
>> then fill all the taken valuse in a list.
>> last Printing the Lists in proper order.
